    ...
    // loop over each item in the data
        for (let i = 0; i < games.length; i++) {
            ...
            gameCard.innerHTML = `
                ...
                <H4>Pledged: ${games[i].pledged}</H4>
                <H4>Goal: ${games[i].goal}</H4>
                `
...
const displayStr = `A total of $${totalRaised.toLocaleString()} has been raised for ${totalGames} games. Currently, ${totalUnfunded} 
${totalUnfunded == 1 ? 'game remains' : 'games remain'} unfunded. We need your help to fund these amazing games!`;
